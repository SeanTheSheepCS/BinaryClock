...
__no_init volatile union
{
  unsigned char P1SEL2;  /* Port 1 Selection2 */ 
  
  struct
  {
    unsigned char P1SEL2_0        : 1; 
    unsigned char P1SEL2_1        : 1; 
    unsigned char P1SEL2_2        : 1; 
    unsigned char P1SEL2_3        : 1; 
    unsigned char P1SEL2_4        : 1; 
    unsigned char P1SEL2_5        : 1; 
    unsigned char P1SEL2_6        : 1; 
    unsigned char P1SEL2_7        : 1; 
  } P1SEL2_bit;  
} @ 0x0041;
...
__no_init volatile union
{
  unsigned char P2SEL2;  /* Port 2 Selection2 */ 
  
  struct
  {
    unsigned char P2SEL2_0        : 1; 
    unsigned char P2SEL2_1        : 1; 
    unsigned char P2SEL2_2        : 1; 
    unsigned char P2SEL2_3        : 1; 
    unsigned char P2SEL2_4        : 1; 
    unsigned char P2SEL2_5        : 1; 
    unsigned char P2SEL2_6        : 1; 
    unsigned char P2SEL2_7        : 1; 
  } P2SEL2_bit;  
} @ 0x0042;
